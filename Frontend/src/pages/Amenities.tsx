...
import { Droplets , Dumbbell, Wind, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Waves, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Droplets  key={0} />, <Dumbbell key={1} />, <Waves  key={2} />, <Wind key={3} />],
